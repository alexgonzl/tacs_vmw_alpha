...
for tt in range(nTrials):
    ...
    for obj in range(thisTrial.nTargets):
        ...
        VWMTrials[tt].Objects[obj].rect.pos = ObjectPositions[tt][obj]
    for obj in range(thisTrial.nDistractors):
        VWMTrials[tt].Objects[obj+thisTrial.nTargets].rect.ori = ObjectOrietations[tt][obj+thisTrial.nTargets]
        VWMTrials[tt].Objects[obj+thisTrial.nTargets].rect.pos = ObjectPositions[tt][obj+thisTrial.nTargets]